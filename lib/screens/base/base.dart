...
class Base extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
                  ...
                  child: Column(
                    children: [
                      Icon(
                        ...
                        color: viewChangeNotifierState.selectedbottomindex == 0
                            ? Color(0xff404040)
                            : Color(0xff8E8E93),
                      ),
                      /*
                  ...
                  child: Column(
                    children: [
                      Icon(
                        FeatherIcons.user,
                        size: screenwidth * 0.0589,
                        color: viewChangeNotifierState.selectedbottomindex == 1
                            ? Color(0xff404040)
                            : Color(0xff8E8E93),
                      ),
                    ],
        ...
        body: viewChangeNotifierState
            .pages[viewChangeNotifierState.selectedbottomindex]);
  }
}
